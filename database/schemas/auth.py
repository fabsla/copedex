...
class User(UserBase, table=True):
    ...
    def has_higher_role(self, role: RoleName):
        return self.role.id > role.value
        
    def has_role_or_higher(self, role: RoleName):
        return self.role.id >= role.value
    
    def has_role(self, role: RoleName):
        return self.role.id == role.value
    
    def has_role_or_lower(self, role: RoleName):
        return self.role.id <= role.value
    
    def has_lower_role(self, role: RoleName):
        return self.role.id < role.value
